...
public enum Material {
    ...
    DARKBLUE_WOOL(1,2, Tile.TileType.FOREGROUND, 2.7f, GenericModifierType.SHEAR_EFFICIENT),
    ...
    DARKGREEN_WOOL(1,8, Tile.TileType.FOREGROUND, 2.7f, GenericModifierType.SHEAR_EFFICIENT),
    WHITE_WOOL(2,0, Tile.TileType.FOREGROUND, 2.7f, GenericModifierType.SHEAR_EFFICIENT),
    LIGHTPURPLE_WOOL(2,1, Tile.TileType.FOREGROUND, 2.7f, GenericModifierType.SHEAR_EFFICIENT),
    ...
    DARKGRAY_WOOL(2,4, Tile.TileType.FOREGROUND, 2.7f, GenericModifierType.SHEAR_EFFICIENT),
    LIGHTGRAY_WOOL(2,5, Tile.TileType.FOREGROUND, 2.7f, GenericModifierType.SHEAR_EFFICIENT),
    PINK_WOOL(2,6, Tile.TileType.FOREGROUND, 2.7f, GenericModifierType.SHEAR_EFFICIENT),
    GREEN_WOOL(2,7, Tile.TileType.FOREGROUND, 2.7f, GenericModifierType.SHEAR_EFFICIENT),
